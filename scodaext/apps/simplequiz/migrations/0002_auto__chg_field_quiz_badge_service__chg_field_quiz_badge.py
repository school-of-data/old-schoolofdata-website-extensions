...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quiz.badge'
        db.alter_column(u'simplequiz_quiz', 'badge', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Quiz.badge_service'
        db.alter_column(u'simplequiz_quiz', 'badge_service_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['simplequiz.BadgeService']))

        # Changing field 'Quiz.badge'
        db.alter_column(u'simplequiz_quiz', 'badge', self.gf('django.db.models.fields.SlugField')(default='', max_length=50))
