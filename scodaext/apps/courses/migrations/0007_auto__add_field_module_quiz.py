...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'courses_module', 'quiz',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['simplequiz.Quiz'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.quiz'
        db.delete_column(u'courses_module', 'quiz_id')
